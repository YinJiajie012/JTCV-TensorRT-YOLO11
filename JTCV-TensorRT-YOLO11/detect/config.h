...
const int kGpuId = 0;
const int kNumClass = 6;
const int kInputH = 1280;
const int kInputW = 1280;
const float kNmsThresh = 0.25f;
const float kConfThresh = 0.4f;
const int kMaxNumOutputBbox = 50;  // assume the box outputs no more than kMaxNumOutputBbox boxes that conf >= kNmsThresh;
...
const std::vector<std::string> vClassNames {
    "heipi", "zangwu", "liewen", "kepeng", "zhedie", "wadao"
};
